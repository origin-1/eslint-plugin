...
const { isOpeningParenToken, makeRuleDocsURL } = require('../utils');
...
const meta =
{
    ...
    docs:
    {
        ...
        url: makeRuleDocsURL('nice-space-before-function-paren'),
    },
    fixable:    'whitespace',
    schema:     [],
    messages:
...
function create(context)
{
    ...
    /**
     * Validates the parens of a function node.
    ...
    const ruleListeners =
    {
        ArrowFunctionExpression:    validateFunction,
        FunctionDeclaration:        validateFunction,
        FunctionExpression:         validateFunction,
    };
