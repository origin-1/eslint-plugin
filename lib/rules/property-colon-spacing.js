 ...
 * @param {string} text A string to count graphemes.
 * @returns {number} The number of graphemes in the given string.
 */
...
function create(context)
{
    ...
    function getShiftMap(properties, excludedProperties)
    {
        ...
        for (const property of properties)
        {
            ...
            if (property.loc.start.line === afterColonStart.line)
            {
                ...
                const colonShift = countGraphemes(sourceCode.getText(colon, colonStart.column));
    ...
    const ruleListeners = { ObjectExpression: verifySpacing, ObjectPattern: verifySpacing };
