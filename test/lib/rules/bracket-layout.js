...
const tests =
{
    ...
    [
        ...
        },
        {
            ...
            errors:
            [
                { messageId: 'sameLineBeforeOpen',  data: { bracket: '(' }, line: 1, column: 4 },
                { messageId: 'sameLineAfterOpen',   data: { bracket: '(' }, line: 1, column: 4 },
                { messageId: 'sameLineBeforeOpen',  data: { bracket: '[' }, line: 1, column: 5 },
                { messageId: 'sameLineAfterOpen',   data: { bracket: '[' }, line: 1, column: 5 },
                { messageId: 'sameLineBeforeOpen',  data: { bracket: '{' }, line: 1, column: 6 },
                { messageId: 'sameLineAfterOpen',   data: { bracket: '{' }, line: 1, column: 6 },
                { messageId: 'sameLineBeforeClose', data: { bracket: '}' }, line: 2, column: 5 },
                { messageId: 'sameLineAfterClose', data: { bracket: '}' }, line: 2, column: 5 },
                { messageId: 'sameLineBeforeClose', data: { bracket: ']' }, line: 2, column: 6 },
                { messageId: 'sameLineAfterClose', data: { bracket: ']' }, line: 2, column: 6 },
                { messageId: 'sameLineBeforeClose', data: { bracket: ')' }, line: 2, column: 7 },
            ],
        },
        {
            code:   'new Foo(bar,\nbaz)',
